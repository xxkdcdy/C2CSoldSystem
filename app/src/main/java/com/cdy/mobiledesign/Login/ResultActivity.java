...
public class ResultActivity extends Activity implements View.OnClickListener {
    ...
    private void initViews(boolean success, String phone) {
        TextView tvVerifyEnd = findViewById(R.id.tvVerifyEnd);
        if (!success) {
            ...
            tvVerifyEnd.setBackgroundResource(R.drawable.smssdk_corner_red_bg);
        } else {
        ...
        tvVerifyEnd.setOnClickListener(this);
